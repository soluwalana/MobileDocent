...
public class CreateMapView extends MapView {
...
private CreateMapView.OnLongpressListener longpressListener;

public CreateMapView(Context context, String apiKey) {
    super(context, apiKey);
}

public CreateMapView(Context context, AttributeSet attrs) {
    super(context, attrs);
}

public CreateMapView(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
}

public void setOnLongpressListener(CreateMapView.OnLongpressListener listener) {
    ...
    if (event.getAction() == MotionEvent.ACTION_DOWN) {
        ...
        longpressTimer.schedule(new TimerTask() {
            ...
            public void run() {
                 ...
                 * by the caller.
                 */
                longpressListener.onLongpress(CreateMapView.this, longpressLocation);
            }
